  ...
  <div class="create-post">
    <div class="container">
      ...
      <div class="blog-actions">
        <button class="shadow-md shadow-gray-300" @click="uploadData">
          Publish Blog
        </button>
...
const uploadData = async () => {
  if (
    ...
    blogHtml.value.length !== 0 &&
    blogFileURL.value.length !== 0
  ) {
    try {
      const docRef = await addDoc(collection(db2, "blogCard"), {
    ...
    error.value = true;
    errorMsg.value =
      "Pease ensure Blog Title, Blog Post and image have been filled!";
    setTimeout(() => {
      errorMsg.value = "";
      error.value = false;
    }, 3500);
